...
export const messages = {
  ...
  contactPage: {
    ...
    form: {
      ...
      phoneCountryLabel: "Código de país",
      phonePlaceholder: "+1 (555) 000-0000",
      phoneHint: "Selecciona tu código de país e ingresa el mejor número para contactarte.",
    ...
    issueTypes: [
      ...
      { value: "listing-ip-authenticity", label: "Listado, PI, Falsificación o Autenticidad" },
  ...
  footerNav: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Cómo Funciona", href: "/es/process" },
        { label: "Blog", href: "/es/blog" },
        { label: "Trabaja con Nosotros", href: "/es/work-with-us" },
  ...
  legalPages: {
    privacy: {
      ...
      sections: [
        ...
        {
          heading: "Contacto",
          body: "Para preguntas sobre esta Política de Privacidad o para solicitar la eliminación de tu información, contacta: contact@jrjreinstaters.com.",
        },
      ],
    },
    terms: {
      ...
      sections: [
        ...
        {
          heading: "Contacto",
          body: "Para preguntas sobre estos Términos de Uso, contacta: contact@jrjreinstaters.com.",
        },
      ],
    },
    disclaimer: {
      ...
      sections: [
        ...
        {
          heading: "Contacto",
          body: "Para preguntas sobre este aviso legal, contacta: contact@jrjreinstaters.com.",
        },
      ],
    },
  },
