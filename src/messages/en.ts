...
export const messages = {
  ...
  contactPage: {
    ...
    form: {
      ...
      phoneHint: "Select your country code and enter the best number to reach you.",
      ...
      sellingPlanLabel: "Selling Plan",
      businessModelLabel: "Business Model",
      suspensionDateLabel: "Date of Suspension / Notice",
      suspensionDateHint: "Approximate date is fine.",
      priorAppealsLabel: "Have you already submitted any appeals?",
    ...
    issueTypes: [
      ...
      { value: "listing-ip-authenticity", label: "Listing, IP, Counterfeit, or Authenticity Issue" },
    ...
    priorAppealsOptions: [
      { value: "", label: "Select…" },
      { value: "no", label: "No — this is the first attempt" },
      { value: "yes", label: "Yes — I have submitted before" },
    ],
    whatsapp: {
      show: true,
  ...
  aboutPage: {
    ...
    whoFor: {
      headline: "Who Is This Service For?",
      subheadline:
